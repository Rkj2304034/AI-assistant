...
const Coustomize2 = () => {
  ...
  return (
    <div className='w-full h-screen bg-gradient-to-t from-black to-blue-950 flex justify-center items-center  flex-col  ' >
      <h2 className='text-white text-4xl m-10 ' >Enter a name for your <span className='text-blue-800' >AI-assitant</span></h2>
      <div className='flex justify-center items-center  ' >
        <input type="text"  value={assistantName} onChange={(e) => setAssitantName(e.target.value)}  className='  p-5 m-10 text-2xl w-md rounded-full bg-opacity-5 border-4 border-white text-white italic  '  placeholder='eg. Sifra'/>
